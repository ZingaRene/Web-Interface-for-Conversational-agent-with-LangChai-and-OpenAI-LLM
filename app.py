...
with col1:
    st.title("Deploying a Web Interface for a Conversational and Search Agent with LangChain and LLM")
...
if prompt := st.chat_input(placeholder = "Type a question to get started..!"):
    ...
    llm_dsa = ChatOpenAI( openai_api_key=openai_api_key, model="gpt-4o-mini",streaming=True)
